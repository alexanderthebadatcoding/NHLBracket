...
async function fetchDataAndFindSlug(slugName) {
  try {
    ...
    const url = `https://api.bracket.game/trpc/collective.getPrices?batch=1&input=%7B%220%22%3A%7B%22contract%22%3A%22nhl%22%2C%22currency%22%3A%22USDC%22%7D%7D`;
...
function getSlugByAcronym(ShortName: string) {
  const data = {
    result: {
      data: {
        json: [
          { acronym: "BOS", slug: "bruins-nation" },
          { acronym: "CAR", slug: "hurricanes-nation" },
          { acronym: "FLA", slug: "panthers-nation" },
          { acronym: "NYR", slug: "rangers-nation" },
          { acronym: "NYI", slug: "islanders-nation" },
          { acronym: "EDM", slug: "oil-country" },
          { acronym: "COL", slug: "avalanche-nation" },
          { acronym: "TOR", slug: "leafs-nation" },
          { acronym: "VGK", slug: "vegas-born" },
          { acronym: "VAN", slug: "canucks-nation" },
          { acronym: "LA", slug: "kings-nation" },
          { acronym: "WPG", slug: "jets-nation" },
          { acronym: "DAL", slug: "stars-nation" },
          { acronym: "TB", slug: "bolts-nation" },
          { acronym: "NSH", slug: "smashville" },
          { acronym: "WSH", slug: "caps-nation" },
        ],
      },
    },
  };
